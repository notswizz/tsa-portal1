        ...
        <div className="px-6 py-6">
          {shows.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="mt-4 text-lg font-medium text-gray-700">No upcoming shows found</p>
              <p className="mt-2 text-sm text-gray-500">Check back later for new show listings</p>
            </div>
          ) : (
            <div className="space-y-6">
              <div>
                ...
                <div className="mt-2 relative rounded-md shadow-sm">
                  <select
                    id="show-select"
                    className="block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 rounded-lg transition-all"
              ...
              {selectedShow && (
                <div className="mt-6 bg-gray-50 rounded-lg p-5 shadow-inner">
                  <div className="mb-5 pb-4 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                      <h4 className="text-xl font-semibold text-gray-800">{selectedShow.name}</h4>
                      <div className="text-sm bg-pink-50 text-pink-600 px-3 py-1 rounded-full font-medium">
                  ...
                  <div className="mt-5 mb-6">
                    <h4 className="text-sm font-medium text-gray-700 mb-4">Please check the dates you're available:</h4>
                      ...
                      {showDates.map((date) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            <label htmlFor={`date-${date}`} className="ml-3 block text-sm text-gray-800 cursor-pointer">
                  ...
                  <div className="flex justify-end mt-6">
                    <button
                      type="button"
                      className="inline-flex items-center px-5 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-pink-500 hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 disabled:opacity-50 transition-all duration-150"
